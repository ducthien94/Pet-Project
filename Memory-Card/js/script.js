var isPlaying = false;
var current = null;
var cards = ['leesin', 'aphelios', 'karma', 'soraka', 'irelia', 'caitlyn', 'nidalee', 'thresh'];
var numberCards = 8;
var point = 0;
var normalTime = 75;
var hardTime = 62;
...
function loadContent() {
    ...
    cards.forEach(item => {
    	$(".content").append(`
			<div class="grid">
				<div class="card" data-name=${item} onclick="flip(this)">
					<div class="front"><img src="img/back-face.jpg"/></div>
					'<div class="back"><img src="img/${item}.jpg"/></div>
				</div>
			</div>
    	`)
    })
